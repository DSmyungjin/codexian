...
2. **`session-start.mjs` hook** (when Codex CLI's SessionStart hook regression is resolved upstream — Phase 3 of codexian's own roadmap). Currently opportunistic; the script is generated by init and ready to register.
